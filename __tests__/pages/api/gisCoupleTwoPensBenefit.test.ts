...
describe('gisCoupleTwoPensBenefit', () => {
  ...
  it('should pass 38 test - CALC-38', async () => {
    ...
    //client results
    expectOasEligible(res, EntitlementResultType.FULL, 989.78)
  ...
  it('should pass 39 test - CALC-39', async () => {
    ...
    //client results
    expectOasEligible(res, EntitlementResultType.FULL, 865.28)
