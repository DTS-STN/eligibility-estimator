...
describe('basic OAS scenarios', () => {
  ...
  it('returns "unavailable" when citizen and under 10 years in Canada and lived in social country', async () => {
    const res = await mockGetRequest({
      income: 10000,
      age: 65,
      maritalStatus: MaritalStatus.SINGLE,
  ...
  it('returns "unavailable" when living in Agreement and under 20 years in Canada', async () => {
    const res = await mockGetRequest({
      income: 10000,
      age: 65,
      maritalStatus: MaritalStatus.SINGLE,
...
describe('OAS entitlement scenarios', () => {
  it('returns "eligible for $317.63" when 20 years in Canada', async () => {
    ...
    expect(res.body.results.oas.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.oas.entitlement.result).toEqual(324.33)
    expect(res.body.results.oas.entitlement.type).toEqual(
      EntitlementResultType.PARTIAL
    )
  })
  it('returns "eligible for $619.38" when 39 years in Canada (rounding test)', async () => {
    ...
    expect(res.body.results.oas.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.oas.entitlement.result).toEqual(632.45)
    expect(res.body.results.oas.entitlement.type).toEqual(
      EntitlementResultType.PARTIAL
    )
  })
  it('returns "eligible for $635.26" when 40 years in Canada', async () => {
    ...
    expect(res.body.results.oas.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.oas.entitlement.result).toEqual(648.67)
...
describe('basic GIS scenarios', () => {
  ...
  it(`returns "ineligible" when single and income equal to ${legalValues.MAX_GIS_INCOME_SINGLE}`, async () => {
    const res = await mockGetRequest({
  ...
  it(`returns "ineligible" when married and no partner OAS and income equal to ${legalValues.MAX_GIS_INCOME_PARTNER_ALW}`, async () => {
    const res = await mockGetRequest({
  ...
  it(`returns "ineligible" when married and partner OAS and income equal to ${legalValues.MAX_GIS_INCOME_PARTNER_OAS} and partner income 0`, async () => {
    const res = await mockGetRequest({
  ...
  it(`returns "ineligible" when married and partner OAS and income equal to ${legalValues.MAX_GIS_INCOME_PARTNER_OAS} and partner income 1000`, async () => {
    const res = await mockGetRequest({
      income: legalValues.MAX_GIS_INCOME_PARTNER_OAS,
      age: 65,
      maritalStatus: MaritalStatus.MARRIED,
  ...
  it(`returns "ineligible" when married and partner partial OAS and income equal to ${legalValues.MAX_GIS_INCOME_PARTNER_OAS} and partner income 0`, async () => {
    const res = await mockGetRequest({
      income: legalValues.MAX_GIS_INCOME_PARTNER_OAS,
      age: 65,
      maritalStatus: MaritalStatus.MARRIED,
...
describe('GIS entitlement scenarios', () => {
  it('returns "$394.68" when single and 10000 income', async () => {
    ...
    expect(res.body.results.gis.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.gis.entitlement.result).toEqual(402.79)
  })
  it('returns "$959.26" when single and 0 income', async () => {
    ...
    expect(res.body.results.gis.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.gis.entitlement.result).toEqual(968.86)
  })
  it('returns "$850.26" when married and 10000 income and no partner OAS', async () => {
    ...
    expect(res.body.results.gis.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.gis.entitlement.result).toEqual(861.86)
  })
  ...
  it('returns "$819.26" when married and 10000 income + 1000 partner income and no partner OAS', async () => {
    ...
    expect(res.body.results.gis.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.gis.entitlement.result).toEqual(830.86)
  })
  it('returns "$306.33" when married and 10000 income + 1000 partner income and partner OAS', async () => {
    ...
    expect(res.body.results.gis.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.gis.entitlement.result).toEqual(311.68)
  })
  it('returns "$521.33" when married and 10000 income + 1000 partner income and partner Allowance', async () => {
    ...
    expect(res.body.results.gis.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.gis.entitlement.result).toEqual(528.68)
  })
  it('returns "$577.43" when married and 0 income + 0 partner income and partner OAS', async () => {
    ...
    expect(res.body.results.gis.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.gis.entitlement.result).toEqual(583.2)
  })
  ...
  it('returns "$1239.38" when single and 1000 income, only 20 years in Canada (Partial OAS)', async () => {
    ...
    expect(res.body.results.gis.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.gis.entitlement.result).toEqual(1252.2)
  })
  it('returns "$1399.95" when single and 1000 income, only 10 years in Canada (Partial OAS)', async () => {
    ...
    expect(res.body.results.gis.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.gis.entitlement.result).toEqual(1414.36)
  })
})

describe('basic Allowance scenarios', () => {
  it(`returns "ineligible" when income equal to ${legalValues.MAX_ALW_INCOME}`, async () => {
    const res = await mockGetRequest({
  ...
  it('returns "unavailable" when not citizen', async () => {
    const res = await mockGetRequest({
      income: 10000,
      age: 60,
      maritalStatus: MaritalStatus.MARRIED,
...
describe('Allowance entitlement scenarios', () => {
  it('returns "eligible for $334.33" when 40 years in Canada and income=20000', async () => {
    ...
    expect(res.body.results.alw.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.alw.entitlement.result).toEqual(341.68)
    expect(res.body.results.alw.eligibility.reason).toEqual(ResultReason.NONE)
  })
  ...
  it('returns "eligible for $565.35" when 40 years in Canada and income=10000', async () => {
    ...
    expect(res.body.results.alw.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.alw.entitlement.result).toEqual(565.35)
    expect(res.body.results.alw.eligibility.reason).toEqual(ResultReason.NONE)
  })
  it('returns "eligible for $1231.87" when 40 years in Canada and income=0', async () => {
    ...
    expect(res.body.results.alw.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.alw.entitlement.result).toEqual(1231.87)
    expect(res.body.results.alw.eligibility.reason).toEqual(ResultReason.NONE)
  })
})
...
describe('AFS entitlement scenarios', () => {
  it('returns "eligible for $260.10" when 40 years in Canada and income=20000', async () => {
    ...
    expect(res.body.results.afs.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.afs.entitlement.result).toEqual(270.73)
    expect(res.body.results.afs.eligibility.reason).toEqual(ResultReason.NONE)
  })
  it('returns "eligible for $681.35" when 40 years in Canada and income=10000', async () => {
    ...
    expect(res.body.results.afs.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.afs.entitlement.result).toEqual(694.4)
    expect(res.body.results.afs.eligibility.reason).toEqual(ResultReason.NONE)
  })
  it('returns "eligible for $1468.47" when 40 years in Canada and income=0', async () => {
    ...
    expect(res.body.results.afs.eligibility.result).toEqual(ResultKey.ELIGIBLE)
    expect(res.body.results.afs.entitlement.result).toEqual(1468.47)
    expect(res.body.results.afs.eligibility.reason).toEqual(ResultReason.NONE)
  })
})
...
describe('thorough personas', () => {
  ...
  it('Habon Aden: OAS unavailable, GIS ineligible due to country', async () => {
    const res = await mockGetRequest({
      income: 28000,
      age: 66,
      maritalStatus: MaritalStatus.SINGLE,
...
describe('thorough extras', () => {
  ...
  it('returns "unavailable" when living in Canada and 9 years in Canada and lived in social country', async () => {
    const res = await mockGetRequest({
      income: 10000,
      age: 65,
      maritalStatus: MaritalStatus.SINGLE,
  ...
  it('returns "unavailable" when living in Agreement and 9 years in Canada', async () => {
    const res = await mockGetRequest({
      income: 10000,
      age: 65,
      maritalStatus: MaritalStatus.SINGLE,
  ...
  it('returns "unavailable" when not living in Canada and 19 years in Canada and lived in social country', async () => {
    const res = await mockGetRequest({
      income: 10000,
      age: 65,
      maritalStatus: MaritalStatus.SINGLE,
