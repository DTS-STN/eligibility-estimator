...
describe('gisCoupleOnePenBenefit', () => {
  ...
  //   const extractedPayload = getTransformedPayloadByName(filePath, desiredName)
  //   const res = await mockGetRequest(extractedPayload)
  //   console.log(desiredName, extractedPayload)
  //   console.log(res)
  ...
  it('should pass 57 test - CALC-57', async () => {
    ...
    console.log(desiredName, extractedPayload)
    console.log(res)
    console.log('future client', res.body.futureClientResults[0])
    console.log('future client', res.body.futureClientResults[1])
    console.log('future partner', res.body.futurePartnerResults[0])
