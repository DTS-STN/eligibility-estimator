  ...
  detail: {
    ...
    oas: {
      eligibleIfIncomeIsLessThan:
        'You are likely eligible for this benefit if {INCOME_SINGLE_OR_COMBINED} is less than {INCOME_LESS_THAN}. If your income is over {OAS_RECOVERY_TAX_CUTOFF}, you may have to pay recovery tax. {LINK_RECOVERY_TAX}.',
      dependOnYourIncome:
