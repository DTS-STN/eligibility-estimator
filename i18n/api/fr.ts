...
const fr: Translations = {
  ...
  questionHelp: {
    ...
    [FieldKey.PARTNER_INCOME]:
      "<p>Sa déclaration de revenus sera évaluée lors de votre demande. Pour l'instant, estimez ce que votre conjoint pourrait recevoir par année.</p>", //overwritten in Stepper/index
    [FieldKey.PARTNER_INCOME_WORK]:
