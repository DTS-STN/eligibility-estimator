...
const fr: Translations = {
  ...
  detail: {
    ...
    gis: {
      ...
      ifYouApply:
        'Si vous présentez une demande, Service Canada révisera votre déclaration de revenus chaque année. Vous recevrez automatiquement des paiements si votre revenu combiné est admissible.',
      canApplyOnline:
