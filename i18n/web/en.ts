...
const en: WebTranslations = {
  ...
  contactCTA:
    'For a more accurate assessment, you are encouraged to contact <a className="text-default-text underline" href="https://www.canada.ca/en/employment-social-development/corporate/contact/oas.html">Service Canada</a> and check out the <a className="underline text-default-text cursor-pointer" onClick="{setSelectedTab(2)}">FAQ</a> on documents you may be required to provide.',
  resultsPage: {
