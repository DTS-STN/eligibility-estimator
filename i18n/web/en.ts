...
const en: WebTranslations = {
  ...
  resultsPage: {
    ...
    yourAnswers: {
      age: 'Edit your age',
      oasDefer: 'Edit when you would like to start receiving Old Age Security',
      incomeAvailable: 'Edit if you will provide your income',
      income: 'Edit your net income',
      legalStatus: 'Edit your legal status',
      livingCountry: 'Edit your country of residence',
      livedOutsideCanada:
        'Edit if you have lived outside Canada for longer than 6 months',
      maritalStatus: 'Edit your marital status',
      partnerIncomeAvailable: "Edit if you will provide your partner's income",
      partnerIncome: "Edit your partner's net income",
      partnerBenefitStatus: "Edit your partner's old age benefits",
      partnerAge: "Edit your partner's age",
      partnerLegalStatus: "Edit your partner's legal status",
      partnerLivingCountry: "Edit your partner's country of residence",
