...
const fr: WebTranslations = {
  ...
  inflationInfo: `Cet estimateur utilise les taux des prestations de juillet à septembre&nbsp;2026. Les montants des prestations futures pourraient être plus élevés en raison de l’inflation.`,
