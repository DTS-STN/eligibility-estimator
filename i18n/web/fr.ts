...
const fr: WebTranslations = {
  ...
  homePageP4:
    'le Supplément de revenu garanti est une prestation mensuelle non imposable destinée aux bénéficiaires de la pension de la Sécurité de la vieillesse qui ont un faible revenu et qui vivent au Canada.',
  homePageP5:
