...
export const MAX_GIS_INCOME_PARTNER_ALLOWANCE = 46656 // same number as below so supposedly fine that it's unused
export const MAX_GIS_INCOME_PARTNER_NO_OAS_NO_ALLOWANCE = 46656
export const MAX_ALLOWANCE_INCOME = 36048
