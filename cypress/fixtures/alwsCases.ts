...
const data = [
  ...
  },
  {
    ...
    alwsEligible: { en: en.result.eligible, fr: fr.result.eligible },
    alwsDetail: {
      en: [en.detail.eligibleIncomeTooHigh],
      fr: [fr.detail.eligibleIncomeTooHigh],
      estimate: false,
    },
    nextSteps: {
  ...
  },
  {
    ...
    nextSteps: {
      en: [en.detail.alwsApply],
      fr: [fr.detail.alwsApply],
      limit: false,
    },
  },
  {
    ...
    alwsDetail: {
      en: [en.detail.futureEligibleIncomeTooHigh2],
      fr: [fr.detail.futureEligibleIncomeTooHigh2],
      estimate: false,
    },
    nextSteps: {
  ...
  },
  {
    ...
    alwsEligible: { en: en.result.ineligible, fr: fr.result.ineligible },
    alwsDetail: {
      en: [en.detail.afsNotEligible],
      fr: [fr.detail.afsNotEligible],
      estimate: false,
    },
  },
]
