...
export const FAQ = () => (
  <div className="">
    <details>
      ...
      <div className="p-4">
        <p>
          The Canada Pension Plan (CPP) and Quebec Pension Plan (QPP) are not
          funded by the Government, but through the contributions of employees
          and employers. To receive CPP or QPP, you must have worked and
          contributed to either plan.
        </p>
      </div>
    </details>
    <details>
      ...
      <div className="p-4 space-y-4">
        ...
        <p>
          ...
          outside Canada, a certificate of Canadian citizenship, naturalization
          certificate, Canadian passport, or Canadian immigration documents
          (such as Record of Landing, permanent resident card or temporary
          resident permit) are required.
        </p>
        <p>
          <span className="font-bold">Proof of Marital Status:</span> If you are
          married, you must provide an original or certified copy of your
          marriage certificate. If you are in a common-law relationship, please
          provide a statutory declaration of your union and other proof of the
          relationship.
        </p>
        ...
        <ul className="list-disc">
          ...
          <li className="ml-12">
            Cohabitation or prenuptial agreement / joint wills or bank accounts
          </li>
        </ul>
      </div>
    </details>
    <details>
      <summary>
        What are the acceptable categories of legal status in Canada?
      </summary>
      <div className="p-4 space-y-4">
        <p>
        ...
        <p>
          <span className="font-bold">
            A permanent resident or landed immigrant (non-sponsored immigrant):
          </span>{' '}
          An individual given permanent resident status by immigrating to Canada
          but is not a Canadian citizen.
        </p>
        <p>
          <span className="font-bold">
            {' '}
          ...
          An individual given permanent resident status under the Family Class,
          has an approved Canadian sponsor, but is not a Canadian citizen.
        </p>
        <p>
          <span className="font-bold"> Temporary Resident Permit</span> -
        ...
        <p>
          ...
          individual may be granted permission to come to Canada for a temporary
          purpose as a visitor, a student or to work for a specified period that
          may be renewed. For instance, a work permit may be issued for an
          individual to work temporarily in Canada or a study permit may be
          issued for an individual to study temporarily at Canadian CEGEPs,
        ...
        <p>
          ...
          and fears returning to that country because of a well-founded fear of
        ...
        <p>
          ...
          prior to the introduction of the permanent resident card, this status
          is granted to people who were outside Canada for more than 183 days
          but not intended to make a permanent home elsewhere.
        </p>
        <p>
          ...
          Canadian reserves. As such, they will have exactly the same rights as
          all Canadian citizens. This can only be used to confirm legal status.
          The residence requirements under the Old Age Security Act still need
          to be met.
        </p>
      </div>
    </details>
    ...
    <details>
      ...
      <div className="p-4">
        <p>
          Canadians working outside Canada for Canadian employers may have their
          time working abroad counted as residence in Canada. To qualify, you
          must have returned to Canada within six months of ending employment or
          have turned 65 while still employed outside Canada. Under certain
          conditions, this provision may also apply to partners, dependents,
          students, and Canadians working abroad for international
          organizations.
        </p>
      </div>
    </details>
    ...
    <details>
      ...
      <div className="p-4">
        <p>
          If you disagree with a decision made on your application, you may ask
          to have the decision reviewed. You must request a reconsideration in
          writing within 90 days of receiving your decision letter. A review of
          you application will be made by Service Canada staff who were not
          involved in the original decision on your application.
        </p>
      </div>
    </details>
    <details>
