    ...
    <details>
      ...
      <div className="p-4 space-y-4">
        <p>
          ...
          de naissance, mais Service Canada peut toutefois vous la demander plus
          tard.
        </p>
        <p>
          <span className="font-bold">Preuve du statut légal:</span> Si vous
          êtes né à l&apos;extérieur du Canada, un certificat de citoyenneté
          canadienne, un certificat de naturalisation, un passeport canadien ou
          des documents d&apos;immigration canadiens (par exemple, une fiche
          relative au droit d&apos;établissement, une carte de résident
          permanent ou un permis de séjour temporaire) sont exigés.
        </p>
        <p>
          <span className="font-bold">La preuve de mariage peut inclure:</span>
          ...
          union de fait, veuillez fournir la déclaration solennelle d&apos;union
        ...
        <ul className="list-disc">
          ...
          <li className="ml-12">
            une attestation de mariage (copie ou extrait officiel du registre du
            bureau de l&apos;état civil avec le numéro d&apos;enregistrement);
          </li>
          <li className="ml-12">
        ...
        <ul className="list-disc">
          ...
          <li className="ml-12">
            la Déclaration solennelle d&apos;union de fait (ISP3004) signée par
            un commissaire à l&apos;assermentation (offert gratuitement dans les
          ...
          <li className="ml-12">
            ...
            Saskatchewan, un certificat d&apos;union de fait du Manitoba, ou un
            accord d&apos;interdépendance entre partenaires adultes de
            l&apos;Alberta;
          </li>
          <li className="ml-12">
          ...
          <li className="ml-12">
            un contrat de cohabitation ou prénuptial, un testament commun ou des
    ...
    <details>
      ...
      <div className="p-4 space-y-4">
        <p>
          ...
          Canada d&apos;un parent citoyen canadien qui est lui-même né au Canada
          ou qui a obtenu la citoyenneté) ou ayant demandé et obtenu la
        ...
        <p>
          ...
          Une personne ayant obtenu le statut de résident permanent en immigrant
          au Canada, mais qui n&apos;a pas encore la citoyenneté canadienne.
        </p>
        <p>
          <span className="font-bold">
        ...
        <p>
          ...
          Un permis qui peut être accordé dans des circonstances exceptionnelles
          à une personne qui ne satisfait pas aux exigences de la loi sur
          l&apos;immigration du Canada pour entrer au Canada ou y demeurer
          temporairement.
        </p>
        <p>
          <span className="font-bold">Visa de résident temporaire (VRT):</span>
          Une personne peut obtenir la permission de venir au Canada à des fins
          temporaires en tant que visiteur, étudiant ou travailleur pour une
          période déterminée qui peut être renouvelée. Par exemple, un permis de
          travail peut être délivré pour qu&apos;une personne puisse travailler
          temporairement au Canada ou un permis d&apos;études peut être délivré
          pour qu&apos;une personne puisse étudier temporairement dans les
          cégeps, collèges et universités canadiens.
        </p>
        <p>
          <span className="font-bold">Réfugié au sens de la Convention</span>
          Personne qui se trouve hors de son pays d&apos;origine ou de résidence
          habituelle et qui ne peut y retourner, parce qu&apos;elle craint avec
          raison d&apos;être persécutée pour des motifs liés à sa race, sa
          religion, sa nationalité, son appartenance à un groupe social
          particulier ou ses opinions politiques.
        </p>
        <p>
        ...
        <p>
          <span className="font-bold">Résident permanent revenant au pays</span>
          Avant l&apos;introduction de la carte de résident permanent, ce statut
          est accordé aux personnes qui se trouvaient à l&apos;extérieur du
          Canada pendant plus de 183 jours, mais qui n&apos;avaient pas
          l&apos;intention de s&apos;établir de façon permanente ailleurs.
        </p>
        <p>
          <span className="font-bold">
          ...
          peut servir qu&apos;à confirmer le statut juridique. Les conditions de
          résidence prévues par la Loi sur la sécurité de la vieillesse doivent
          encore être remplies.
        </p>
      </div>
    </details>
    <details>
    ...
    <details>
      ...
      <div className="p-4">
        <p>
          ...
          employeurs canadiens peuvent avoir leur temps à l&apos;étranger compté
          comme résidence au Canada. Pour faire compter cette période de travail
          à l&apos;étranger, vous devez être retourné au Canada dans les 6 mois
          suivant la fin de l&apos;emploi ou avoir eu 65 ans alors que vous
          occupiez encore un emploi et avoir maintenu votre résidence au Canada
          pendant votre séjour à l&apos;extérieur du Canada. Sous certaines
          conditions, les conjoints, les conjoints de fait, les personnes à
          charge et les Canadiens qui travaillent à l&apos;étranger pour des
          organisations internationales peuvent également compter le temps passé
          à l&apos;étranger comme résidence au Canada.
        </p>
      </div>
    </details>
    <details>
    ...
    <details>
      ...
      <div className="p-4">
        <p>
          ...
          réexamen de votre demande. Vous devez présenter une telle demande par
          écrit dans les 90 jours suivant la réception de la lettre de
